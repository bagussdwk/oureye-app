        ...
        <div class="right_col" role="main">
          <div class="row top_tiles">
            ...
            <div class="x_content" style="padding-left: 230px; padding-top: 100px;">
              <div class="bs-example" data-example-id="simple-jumbotron">
                <div class="jumbotron col-lg-9">
                  <h1>Halo, <?= $user['name']; ?> &#128513;</h1>
                  <p>Selamat datang di dashboard admin. Kamu bisa mengelola <br> data-data aplikasi sistem pakar mata di <b>OurEye</b> ini.</p>
                </div>
              </div>
            </div>
          </div>
