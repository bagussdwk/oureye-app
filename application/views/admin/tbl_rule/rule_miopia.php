                        ...
                        <?php foreach ($miopia as $m) : ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="<?= base_url('rule/hapusRule/') . $m['id']; ?>" style="padding: 1em 1.2em 1em;" class="tombol-hapus buttonku buttonku--moemadel buttonku--text-thick buttonku--text-upper buttonku--size-s">hapus</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        <?php endforeach; ?>
